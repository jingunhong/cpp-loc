...
def package(bundle: Path, out: Path) -> dict:
    ...
    card += (
        ...
        "IDs/reasons, and parent hashes are in release.json. Dedicated raw-mail, full-patch, "
        "and fixing-message companions and caches remain local. Retained reports may "
        "still contain quoted mail and code or patch snippets.\n\n"
